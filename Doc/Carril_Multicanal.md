...
> arrancar. Conectado con `Doc/PENDIENTES.md` §FRENTE C y las brechas OC-C*/HG-* (multi-canal).
...
1. Leer este MD + `Doc/PENDIENTES.md` §FRENTE C + las brechas OC-C1..C7 / HG-1..3 (el detalle de
...
4. ⚠️ Reusar: `telegram_channel.py` y `api_channel.py` son el molde de "cómo se conecta un canal".
...
> Todas estas están registradas a detalle en `Doc/PENDIENTES.md` §BRECHAS OPENCLAW/HERMES
...
Relacionado: `Doc/PENDIENTES.md` §FRENTE C + §BRECHAS OPENCLAW (OC-C1..C7) + §BRECHAS HERMES (HG-1..3)
· `Alma/Aprendizajes_De_Campo_Post_Incubathon.md` (el origen del Frente C) ·
