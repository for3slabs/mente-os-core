...
**Migrated:** Doc/Radiografia_Fruterito_Personal_MainWSL.md → docs/analysis/Radiografia_Fruterito_Personal_MainWSL.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `docs/analysis/Radiografia_Fruterito_Personal_MainWSL.md`).
