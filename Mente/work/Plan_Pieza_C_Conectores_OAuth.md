...
**Migrated:** Cuerpo/Plan_Pieza_C_Conectores_OAuth.md → work/Plan_Pieza_C_Conectores_OAuth.md (2026-07-30, ADR-029)
...
*Relacionado: `vision/Vision_Conectores_SelfService_Panel_Agente.md` (§C) · piezas A (identidad) y B
(chat) ya listas · S3 (reportado en `work/Ronda_Maestro_Puentes_C_D.md` §barrido) · memoria
