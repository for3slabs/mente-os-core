...
**Migrated:** Doc/Analisis_LearningLoop_Hermes_para_For3s.md → docs/analysis/Analisis_LearningLoop_Hermes_para_For3s.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `docs/analysis/Analisis_LearningLoop_Hermes_para_For3s.md`).
