...
**Migrated:** Doc/Radiografia_Fruterito_WSL.md → docs/analysis/Radiografia_Fruterito_WSL.md (2026-07-30, ADR-029)
...
> WHERE fuente='fruterito-wsl'`). Gemela de `docs/analysis/Radiografia_Fruterito_Principal.md`.
...
*Manifiesto vivo en BD de brian · Plan: `work/Plan_Implementacion_Entrenamiento.md` · E1 ✅*

---

Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `docs/analysis/Radiografia_Fruterito_WSL.md`).
