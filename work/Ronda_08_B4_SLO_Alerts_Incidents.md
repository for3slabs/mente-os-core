...
**Migrated:** Cuerpo/Ronda_08_B4_SLO_Alerts_Incidents.md → work/Ronda_08_B4_SLO_Alerts_Incidents.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_08_B4_SLO_Alerts_Incidents.md`).
