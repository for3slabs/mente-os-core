...
- **Canal API** (`api_channel.py`): `/v1/health`, `/v1/chat`, `/v1/maestro/*`. Tiene `_identidad(auth)`
...
*Relacionado: `Alma/Vision_Conectores_SelfService_Panel_Agente.md` (§A + §2-BIS decisión raíz) ·
`Doc/Plan_Pieza_E_Concentrado_Admin.md` (pieza previa) · memoria `project_conectores_selfservice`.*
