...
**Migrated:** Doc/Analisis_Free_Threading_GIL.md → docs/analysis/Analisis_Free_Threading_GIL.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `docs/analysis/Analisis_Free_Threading_GIL.md`).
