...
**Migrated:** Cuerpo/Ronda_08_B2_Grafana_Dashboards.md → work/Ronda_08_B2_Grafana_Dashboards.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_08_B2_Grafana_Dashboards.md`).
