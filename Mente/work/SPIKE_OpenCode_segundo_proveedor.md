...
**Migrated:** Tickets/SPIKE_OpenCode_segundo_proveedor.md → work/SPIKE_OpenCode_segundo_proveedor.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/SPIKE_OpenCode_segundo_proveedor.md`).
