...
**Migrated:** Alma/Vision_Conectores_SelfService_Panel_Agente.md → vision/Vision_Conectores_SelfService_Panel_Agente.md (2026-07-30, ADR-029)
...
**Del lado sitio (`marca-personal`, doc `marca-personal/Mente/Doc/Demo_For3s_Avance.md` ⚠️ (otro proyecto, tras el gate)):**
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `vision/Vision_Conectores_SelfService_Panel_Agente.md`).
