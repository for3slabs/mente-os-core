...
**Documentos hermanos:**
- [Banco_Infografias_Completo.md](Banco_Infografias_Completo.md) — banco de las 81+ infografías
...
**Próximo paso:** ver [Banco_Filtro_Alineacion.md](Banco_Filtro_Alineacion.md) que filtra TODO el banco (infografías + diario) contra el Grafo Maestro y dice exactamente qué se queda y qué se va.
