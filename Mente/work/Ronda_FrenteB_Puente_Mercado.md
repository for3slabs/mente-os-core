...
**Migrated:** Cuerpo/Ronda_FrenteB_Puente_Mercado.md → work/Ronda_FrenteB_Puente_Mercado.md (2026-07-30, ADR-029)
...
> Incubathon" a **PRODUCTO para clientes de pago**. Método: `rules/ESTANDAR_Metodo_Fases_F.md`.
...
- **Doc `memory/archive/Estandar_De_Datos_For3s_v1.md`** (cara al cliente + checklist SOC2): qué datos toca
...
(stdlib, 2 planos). Commit `30ea6e1`. **Informe completo: `memory/archive/Informe_Carga_F5.md`.**
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_FrenteB_Puente_Mercado.md`).
