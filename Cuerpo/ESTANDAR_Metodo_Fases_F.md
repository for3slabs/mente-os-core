...
Todo hito grande empieza con una **Ronda de diseño a profundidad** en `Mente/Cuerpo/Ronda_*.md`
...
`Cuerpo/Ronda_Reconstruccion_FOR3S_ROLE.md` (§5-BIS batería detallada) ·
