...
> **Método:** Fases "F" (`ESTANDAR_Metodo_Fases_F.md`). Esta ronda ES la F0.
...
- **Entregable:** `Doc/Entrenamiento_Manifiesto.md` (+ CSV/JSON de trabajo) — el tablero de
...
H5/H6/H12 (memoria, consolidación, skills) · `ESTANDAR_Metodo_Fases_F.md`.*