...
**Entregable:** `Doc/Entrenamiento_Catalogo_Codigo.md` (591 filas) + ~10 episodios-resumen.
...
*Cruza con: `Plan_Implementacion_Entrenamiento.md` (E0-E5b) · `Entrenamiento_Ejecucion_Reporte.md` ·
