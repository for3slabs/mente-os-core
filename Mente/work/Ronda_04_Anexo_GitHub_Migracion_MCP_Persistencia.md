...
**Migrated:** Cuerpo/Ronda_04_Anexo_GitHub_Migracion_MCP_Persistencia.md → work/Ronda_04_Anexo_GitHub_Migracion_MCP_Persistencia.md (2026-07-30, ADR-029)
...
De `work/Ronda_04_Bloque_2_MCP_Servers_Core.md`:
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_04_Anexo_GitHub_Migracion_MCP_Persistencia.md`).
