...
> **Método:** `Cuerpo/ESTANDAR_Metodo_Fases_F.md`. **Regla madre:** explicar → aprobar → construir.
...
Relacionado: `Cuerpo/ESTANDAR_Metodo_Fases_F.md` · `project_ci_verde_seguridad` (SEC-4c salió de ahí)
