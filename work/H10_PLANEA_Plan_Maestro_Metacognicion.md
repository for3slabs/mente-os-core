...
**Migrated:** Cuerpo/H10_PLANEA_Plan_Maestro_Metacognicion.md → work/H10_PLANEA_Plan_Maestro_Metacognicion.md (2026-07-30, ADR-029)
...
>
> **Diseño LOCKED base:** `work/Ronda_06_Bloque_1_PFC_Orchestrator.md` (8 señales, 5 niveles,
> check loop) + `work/Ronda_06_Pre_Code_Review_Detailed.md`. Este doc ATERRIZA ese diseño a la
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/H10_PLANEA_Plan_Maestro_Metacognicion.md`).
