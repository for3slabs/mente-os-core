...
**Migrated:** Cuerpo/Plan_Implementacion_Entrenamiento.md → work/Plan_Implementacion_Entrenamiento.md (2026-07-30, ADR-029)
...
> **Ejecuta el flujo:** `work/Flujo_Extraccion_Entrenamiento.md` (FE0–FE8) — este plan lo ORDENA
...
*Ejecuta: `work/Flujo_Extraccion_Entrenamiento.md` · Bloques: `Entrenamiento_Bloques_…Dev.md` ·
Ronda: `work/Ronda_Entrenamiento_Plan_Maestro.md` · Radiografías principal/dev. Método F en cada
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Plan_Implementacion_Entrenamiento.md`).
