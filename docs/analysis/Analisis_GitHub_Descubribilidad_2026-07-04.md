...
**Migrated:** Doc/Analisis_GitHub_Descubribilidad_2026-07-04.md → docs/analysis/Analisis_GitHub_Descubribilidad_2026-07-04.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `docs/analysis/Analisis_GitHub_Descubribilidad_2026-07-04.md`).
