...
- **Docs del hito:** `Cuerpo/Plan_Implementacion_Entrenamiento.md` (etapas E0-E5, LÍNEA DE TIEMPO
...
- **🔬 E6 BACKLOG PROFUNDO (Brian: archivo por archivo, nada omitido — plan
  ...
  `Doc/Entrenamiento_Catalogo_Codigo.md` (15 proyectos) + 15 episodios-resumen** · **F4.1 triage
...
`Doc/For3s_OS_Completo_Vision_Web.md` (✅ hoy vs 🔜 roadmap) · pendiente CRON CONVERSACIONAL
...
y arreglé 10 bugs, cazando 4 extra. Docs: `Doc/REPORTE_MAESTRO_BUGS_2026-07-02.md` (maestro) ·
...
estaba hecho (`Doc/Analisis_intern-os_para_For3s.md`); AI1-AI7 ya en producción (jun). Quedaban los 3
...
- ✅ `Doc/Reporte_Alineacion_R1-R10_vs_Grafo_Vision.md` — alineación diseño vs Grafo/Visión (veredicto 9.2/10)
- ✅ `Doc/Reporte_Maestro_Consolidado_R1-R10.md` — los 10 R como UN sistema (tech concuerda, ~8 columnas vertebrales reusadas, costos, flujo de datos)
- ✅ `Doc/Plan_Maestro_Programacion.md` — **el ORDEN de construcción** (6 fases foundation-first + 3 diagramas + mapa flujo datos + gates + MVP vs diferido)
- ✅ `Doc/Estimacion_Tiempo_Por_Subtema.md` — **el TIEMPO** (~100 sub-temas estimados; ver §3 abajo)
...
Lista completa a detalle: `Doc/PENDIENTES.md`.

---

### (histórico) 🚨 FASE PROFESIONALIZACIÓN (PR1-PR10) — 7/10 HECHOS. Avance al 2026-06-30:
- ✅ **PR1** (claridad: `Doc/PR1_Mapa_Codigo_Claridad.md` — 47 módulos por capas, estado, deuda).
...
- ✅ **PR7** (revisión hitos: `Doc/PR7_Revision_Hitos.md` — 12/12 verificados EN CONTENEDOR VIVO:
...
- Lista completa: `Doc/PENDIENTES.md` §PROFESIONALIZACIÓN + §BUGS + §MANTENIMIENTO.
...
**📋 PENDIENTES (lista consolidada):** ver `Doc/PENDIENTES.md`. Seguridad ✅ cerrada. Lo abierto es POST-MVP: las 5 capacidades P1-P5 (paridad Hermes, prioritarias), webhooks+multi-tenant (diferidos por bloqueadores de red/diseño), mini-agente HTTP demo, Notion/cron/otros canales, hallazgos de fondo H-B/C/D/G.
...
- ⭐ `Doc/Mapa_Construccion_Incremental.md` — **EL DOCUMENTO DE OBRA.** 2 cimientos (C0 servidor, C1 esqueleto) + 16 hitos VERTICALES demoables (H1 HABLA → H16 PRODUCCIÓN). Cada hito termina en un DEMO que se ve funcionando en el servidor for3s. Es el ORDEN real de ensamblaje. **Se construye en for3s (LEY), un hito a la vez, NUNCA implementar sin explicar+aprobar primero.** **C0·C1·H1·H2·H3·H4 ✅ = MVP CERRADO.** Próximo: H5+ (memoria real/KG), pero la PRIORIDAD de Brian son las 5 capacidades P1-P5 (§3.1) — varias se anclan a H5/H8/H12.
- `Doc/Plan_Maestro_Programacion.md` — el MARCO de fases/gates/MVP-vs-diferido (sigue vigente; el Mapa Incremental lo re-rebana en vertical).
- `Doc/Estimacion_Tiempo_Por_Subtema.md` — cuánto tarda cada sub-tema.
...
**(En paralelo) mejora de Mente OS:** cold-start brief (este archivo) + bitácora. Ver `Doc/Bitacora_Progreso.md`.
...
| Necesitas... | Lee... |
|---|---|
| El diseño arquitectónico maestro (11 nodos + 3 pilares) | `Mente/Cerebro/For3s_OS_Grafo_Maestro.md` |
| **El ORDEN de programación (6 fases + diagramas + flujo datos + gates)** | `Mente/Doc/Plan_Maestro_Programacion.md` |
| **El TIEMPO de programación (~100 sub-temas estimados)** | `Mente/Doc/Estimacion_Tiempo_Por_Subtema.md` |
| Alineación diseño vs Grafo/Visión (veredicto 9.2/10) | `Mente/Doc/Reporte_Alineacion_R1-R10_vs_Grafo_Vision.md` |
| Los 10 R consolidados como UN sistema (tech/costos/flujo) | `Mente/Doc/Reporte_Maestro_Consolidado_R1-R10.md` |
| Numeración canónica de nodos (tabla vieja→nueva) | `Mente/Cerebro/Mapeo_Nodo_Cerebral_Tabla_SQL.md` §0 |
...
| 🚨 **Profesionalización PR1-PR10 + todo lo pendiente** | `Mente/Doc/PENDIENTES.md` §"PROFESIONALIZACIÓN" |
| ✅ **PR7 — revisión de los 12 hitos en contenedor vivo (evidencia real + 6 deudas HA)** | `Mente/Doc/PR7_Revision_Hitos.md` |
| 🗺️ **PR1 — mapa del código (47 módulos por capas, qué conecta a qué)** | `Mente/Doc/PR1_Mapa_Codigo_Claridad.md` |
| 🧠 **PR4 — flujo usuario/memoria archivo×archivo + caso de uso + 47 módulos** | `Mente/Doc/PR4_Flujo_Usuario_Memoria.md` |
| Detalle de una ronda técnica específica (R1-R10) | `Mente/Cuerpo/Ronda_XX_*.md` |
| El historial cronológico de cierres de ronda | `Mente/Doc/Estado_Sesion_Continuidad.md` §3.1.x (al final) |
| Estado/reglas/contexto completo (snapshot grande) | `Mente/Doc/Estado_Sesion_Continuidad.md` (200KB — solo si imprescindible) |
| Decisiones de empresa LOCKED (D-001 a D-040) | `for3s-inter/07-operations/decision-log.md` |
| Bitácora de progreso (qué pasó cada periodo) | `Mente/Doc/Bitacora_Progreso.md` |
