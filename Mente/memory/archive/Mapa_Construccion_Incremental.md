...
**Migrated:** Doc/Mapa_Construccion_Incremental.md → memory/archive/Mapa_Construccion_Incremental.md (2026-07-30, ADR-029)
...
```
   LEY 1 — SE CONSTRUYE EN EL SERVIDOR for3s. PUNTO.
           ...
           commit 1. (Acceso: Mente/secrets/Conectar_Servidor_For3s.md)
...
**Este documento NO contradice al `memory/archive/Plan_Maestro_Programacion.md`** — lo reordena en vertical. El Plan Maestro define las fases, los gates y el MVP-vs-diferido (sigue vigente como marco); ESTE define la secuencia de hitos demoables. Mismo contenido, re-rebanado para construir sin esperar.
...
**Estimación gruesa total** (Brian solo, full-time, ±30% — detalle en `memory/archive/Estimacion_Tiempo_Por_Subtema.md`):
