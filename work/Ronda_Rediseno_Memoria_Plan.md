...
**Migrated:** Cuerpo/Ronda_Rediseno_Memoria_Plan.md → work/Ronda_Rediseno_Memoria_Plan.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_Rediseno_Memoria_Plan.md`).
