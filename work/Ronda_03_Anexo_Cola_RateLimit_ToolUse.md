...
**Migrated:** Cuerpo/Ronda_03_Anexo_Cola_RateLimit_ToolUse.md → work/Ronda_03_Anexo_Cola_RateLimit_ToolUse.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_03_Anexo_Cola_RateLimit_ToolUse.md`).
