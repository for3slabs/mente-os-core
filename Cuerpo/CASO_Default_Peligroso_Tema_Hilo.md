...
> **Fecha:** 2026-07-26 · **Origen:** pulido de la demo (`marca-personal`) + agente (`api_channel.py`).
...
Una sola línea en `api_channel.py` del agente:
```python
...
- Agente: `api_channel.py` (`TEMA_DEFAULT="sin-tema"`, `TEMA_REQUERIDO` apagado). Aplicado en
