...
**Migrated:** Cuerpo/Ronda_CI_Confianza_Plan.md → work/Ronda_CI_Confianza_Plan.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_CI_Confianza_Plan.md`).
