...
**Migrated:** Cuerpo/Ronda_FrenteE_Confianza_Para_Delegar.md → work/Ronda_FrenteE_Confianza_Para_Delegar.md (2026-07-30, ADR-029)
...
> (`vision/Aprendizajes_De_Campo_Post_Incubathon.md` §2). Brian eligió atacarlo 2026-07-15
> (Frente C multi-canal queda pendiente sin urgencia — integraciones pesadas, "hay que sentarlos").
> **Método:** `rules/ESTANDAR_Metodo_Fases_F.md`.
...
- **F3 · RED DE SEGURIDAD VISIBLE + AUDITORÍA DE EXPOSICIÓN A DEMANDA. ✅ HECHA 2026-07-15
  ...
  `docs/analysis/Auditoria_Seguridad_For3s_OS.md`. Batería §5-BIS: pytest 244, /salud 0 FAIL, pentest
  SÓLIDO de nuevo.
- **F4 · PILOTO TESTER (jazz). ✅ HECHA 2026-07-16 (commit `c51a267` firmado, server SIN push).**
  ...
  **Regla de Brian: F4 = CAZAR bugs de tester real. 2 bugs cazados+arreglados:** BUG-E1 (/mision y
  ...
  puerta cerrada por defecto, red sandbox). Doc: `memory/archive/Piloto_Tester_Jazz_F4.md`. Verificado en vivo
...
- **F5 · PILOTO CLIENTE REAL. ✅ HECHA 2026-07-16 (por SIMULACIÓN honesta — server SIN cambios de
  ...
  **simular el recorrido del cliente**: actué como cliente de hotel por la URL PÚBLICA
  ...
  borra todo lo suyo en vez de 400. Doc: `memory/archive/Piloto_Cliente_Real_F5.md`. Datos limpios. ⏳ Falta
...
`rules/ESTANDAR_Metodo_Fases_F.md` · [[feedback_explicar_antes_de_implementar]].

---

Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_FrenteE_Confianza_Para_Delegar.md`).
