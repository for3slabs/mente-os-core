...
**Migrated:** Cuerpo/H9_SUENA_Plan_Maestro_DMN.md → work/H9_SUENA_Plan_Maestro_DMN.md (2026-07-30, ADR-029)
...
>
> **Fuente de verdad del diseño:** `work/Ronda_05_Bloque_4_DMN_Default_Mode.md` +
> `work/Ronda_05_DMN_Tasks_Detailed.md` (los 8 trigger_fn/action_fn + ROI + auto-improvement).
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/H9_SUENA_Plan_Maestro_DMN.md`).
