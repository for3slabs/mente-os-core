...
**Migrated:** Doc/Estimacion_Tiempo_Por_Subtema.md → memory/archive/Estimacion_Tiempo_Por_Subtema.md (2026-07-30, ADR-029)

> **El cronograma con números.** El `memory/archive/Plan_Maestro_Programacion.md` da el ORDEN; este documento da el TIEMPO, bajando a nivel de cada sub-tema de las 10 rondas. Convierte los `[EST.]` del plan en una estimación granular y trazable.
...
**Documentos hermanos:**
- `memory/archive/Plan_Maestro_Programacion.md` — el ORDEN de construcción (este da el TIEMPO)
- `docs/analysis/Reporte_Maestro_Consolidado_R1-R10.md` §8 — estimación gruesa previa
