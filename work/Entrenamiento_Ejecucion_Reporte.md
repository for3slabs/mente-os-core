...
**Migrated:** Doc/Entrenamiento_Ejecucion_Reporte.md → work/Entrenamiento_Ejecucion_Reporte.md (2026-07-30, ADR-029)
...
> **Diseño previo:** `work/Ronda_Entrenamiento_Plan_Maestro.md` (etapas) ·
> `work/Flujo_Extraccion_Entrenamiento.md` (el tubo FE0-FE8) ·
> `work/Ronda_Entrenamiento_Plan_Maestro.md` (F0) · radiografías (censo).
...
- **E1 censo (cc12697):** `entrenamiento_censo.py` — walker de las 2 raíces → 11,664
  ...
  tiempo ene→may → 5 olas. Generó `docs/analysis/Radiografia_Fruterito_WSL.md`.
