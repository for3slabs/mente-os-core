...
**Migrated:** Doc/Carril_Mejora_Continua_Confianza.md → work/Carril_Mejora_Continua_Confianza.md (2026-07-30, ADR-029)
...
> `memory/PENDIENTES.md` §Frente E y `project_frente_e_confianza_delegar`.
>
...
> (`rules/ESTANDAR_Metodo_Fases_F.md`). Este carril es la CAPA DE ARRIBA: por qué y cuándo se
...
- **F-A2 · sub-agentes en paralelo → A HECHO / C DIFERIDO (2026-07-16).** Análisis honesto
  (`work/Ronda_FA2_Subagentes_Paralelos_Mision.md`): el freno real NO es el código sino el cupo
...
Relacionado: `memory/PENDIENTES.md` §Frente E · `work/Ronda_FrenteE_Confianza_Para_Delegar.md`
(la vuelta 1 completa) · `project_frente_e_confianza_delegar` (memoria) · `memory/archive/Piloto_Tester_Jazz_F4.md`
· `memory/archive/Piloto_Cliente_Real_F5.md` · `docs/analysis/Auditoria_Seguridad_For3s_OS.md` ·
`rules/ESTANDAR_Metodo_Fases_F.md` (el método técnico de cada pieza).

---

Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Carril_Mejora_Continua_Confianza.md`).
