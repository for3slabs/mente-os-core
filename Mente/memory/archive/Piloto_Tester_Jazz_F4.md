...
**Migrated:** Doc/Piloto_Tester_Jazz_F4.md → memory/archive/Piloto_Tester_Jazz_F4.md (2026-07-30, ADR-029)
...
Relacionado: `work/Ronda_FrenteE_Confianza_Para_Delegar.md` §F4 · [[project_frente_e_confianza_delegar]]
· [[project_multi_instancia]] · `docs/analysis/Auditoria_Seguridad_For3s_OS.md` (F3).
