...
**Migrated:** Cuerpo/Plan_Pieza_D_API_Keys_Self_Service.md → work/Plan_Pieza_D_API_Keys_Self_Service.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Plan_Pieza_D_API_Keys_Self_Service.md`).
