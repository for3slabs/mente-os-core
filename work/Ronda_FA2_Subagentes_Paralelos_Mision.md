...
**Migrated:** Cuerpo/Ronda_FA2_Subagentes_Paralelos_Mision.md → work/Ronda_FA2_Subagentes_Paralelos_Mision.md (2026-07-30, ADR-029)
...
Relacionado: `work/Carril_Mejora_Continua_Confianza.md` (F-A2 = semilla) · `project_h8_equipo_avance`
(el equipo multi-agente) · §EXTRAS BYOK (el cupo por cliente que quitaría el freno) ·
[[feedback_explicar_antes_de_implementar]].

---

Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_FA2_Subagentes_Paralelos_Mision.md`).
