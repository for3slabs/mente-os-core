...
> `Doc/Analisis_LearningLoop_Hermes_para_For3s.md`. Plan de obra (vista alto nivel):
> `Doc/H10-H12_Plan_Maestro_APRENDE.md`. Diseño del governor: `Ronda_06_Pre_Code_Review_Detailed.md` §A.
>
...
> Refs cruzadas: `Doc/H10-H12_Plan_Maestro_APRENDE.md` (plan + estado) ·
> `Ronda_06_Pre_Code_Review_Detailed.md` §A (diseño del governor, umbrales originales) ·
> `Doc/Analisis_LearningLoop_Hermes_para_For3s.md` (de dónde salió la idea) ·
