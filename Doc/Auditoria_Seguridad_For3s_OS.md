...
- **Doble candado de aislamiento** (`api_channel.py` + `memory.py`): cada cliente API recibe un
...
probe_db · DELETE audit · batería §5-BIS. Ronda: `Cuerpo/Ronda_FrenteE_Confianza_Para_Delegar.md` §F3.
