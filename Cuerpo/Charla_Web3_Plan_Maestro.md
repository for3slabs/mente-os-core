...
> **Fuente base:** PENDIENTES §VALIDACION_WEB3 · `Doc/PLAN_PRUEBAS_EXHAUSTIVO.md` (guion base).
...
- [ ] **Guion de la demo en vivo** — secuencia EXACTA de mensajes a Foresito (con la respuesta
      esperada de cada uno). Base: `PLAN_PRUEBAS_EXHAUSTIVO.md`. → doc aparte cuando arranquemos.
...
*Cruza con: PENDIENTES §VALIDACION_WEB3 · `Doc/PLAN_PRUEBAS_EXHAUSTIVO.md` ·
