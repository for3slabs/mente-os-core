...
2. Después lee [README.md](README.md) (índice maestro de Mente/Doc/)
...
2. **`Mente/Cerebro/For3s_OS_Grafo_Maestro.md`** — la verdad arquitectónica
...
```
   ...
   [ ] LEÍ Mente/Doc/README.md (índice maestro)
...
✅ `Mente/Doc/Estado_Sesion_Continuidad.md` (esta §3.1.R9)
...
✅ `Mente/Doc/Estado_Sesion_Continuidad.md` (esta §3.1.R10)
