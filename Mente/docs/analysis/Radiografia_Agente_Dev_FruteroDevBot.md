...
**Migrated:** Doc/Radiografia_Agente_Dev_FruteroDevBot.md → docs/analysis/Radiografia_Agente_Dev_FruteroDevBot.md (2026-07-30, ADR-029)
...
> Hermano de: `docs/analysis/Radiografia_Fruterito_Principal.md` (el árbol completo).
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `docs/analysis/Radiografia_Agente_Dev_FruteroDevBot.md`).
