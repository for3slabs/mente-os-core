...
**Migrated:** Cuerpo/Ronda_08_B3_Audit_Infrastructure.md → work/Ronda_08_B3_Audit_Infrastructure.md (2026-07-30, ADR-029)
...
Related: `docs/plan-v1-to-v2-migration.md` (migrado desde `work/Ronda_08_B3_Audit_Infrastructure.md`).
